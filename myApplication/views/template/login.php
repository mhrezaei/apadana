...
<html lang="en"><head>
        ...
        <meta charset="utf-8">
        <title>ورود به سامانه مدیریت صرافی آپادانا</title>
        ...
        <link href="<?php echo assets_url(); ?>css/admin/bootstrap.login.css" rel="stylesheet">
        <link href="<?php echo assets_url(); ?>css/admin/main.css" rel="stylesheet">
        <link href="<?php echo assets_url(); ?>css/admin/bootstrap-responsive.css" rel="stylesheet">
        ...
        <script src="<?php echo assets_url(); ?>js/admin/ga.js" async="" type="text/javascript"></script>
    ...
    <body>
        ...
        <div style="opacity: 1; top: 0px;" id="login-view">
            <h1 class="center">
                ...
                <span style="font-size: 18px;">ورود به سامانه مدیریت صرافی آپادانا</span>
                <br>
            </h1>
