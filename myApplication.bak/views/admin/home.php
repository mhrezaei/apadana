...
<div class="contentModel" id="currencyData" style="display: none;">
    ...
    <div class="mainDiv" style="text-align: right; min-height: 100px;">
        ...
        <table style="direction: rtl; font-size: 12px; margin: 0 auto; width: 850px;" class="yekan">
            <thead>
            <tr>
                <th style="text-align: center; background: #cecece; font-size: 14px; direction: rtl;" colspan="5">ویرایش نرخ ارز و حواله جات</th>
            </tr>
            <tr>
                <th style="text-align: center; width: 10%;">ردیف</th>
                <th style="text-align: center; width: 15%;">نام ارز</th>
                <th style="text-align: center; width: 25%; direction: rtl;">خرید اسکناس</th>
                <th style="text-align: center; width: 25%; direction: rtl;">فروش اسکناس</th>
                <th style="text-align: center; width: 25%; direction: rtl;">فروش حواله</th>
            </tr>
            </thead>
