<?php
	...
	//bootstrap...
	thtml_stylesheet("libs/bootstrap/css/bootstrap.min"		);
////	thtml_stylesheet("libs/bootstrap/css/bootstrap-theme.min"	);
	thtml_stylesheet("libs/bootstrap/css/bootstrap-rtl.min"	);
////	thtml_stylesheet("libs/bootstrap/css/bootstrap-taha"		);
	thtml_javascript("libs/bootstrap/js/bootstrap.min"		);
